...
class Campaign {
  ...
  /// Konvertiert die Kampagne zu einer Datenbank-Map
  Map<String, dynamic> toMap() {
    return {
      ...
      'player_character_ids': playerCharacterIds.isNotEmpty ? playerCharacterIds.join(',') : null,
      'quest_ids': questIds.isNotEmpty ? questIds.join(',') : null,
      'wiki_entry_ids': wikiEntryIds.isNotEmpty ? wikiEntryIds.join(',') : null,
      'session_ids': sessionIds.isNotEmpty ? sessionIds.join(',') : null,
      'settings': _encodeJson(settings.toMap()),
      'stats': _encodeJson(stats.toMap()),
    };
  }
